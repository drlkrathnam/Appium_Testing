...
# Vaccination--10 Pneumococcal Conjugate Vaccine(PCV)
...
driver.find_element('xpath',"//android.view.View[@bounds='[0,688][576,864]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=719).perform()
...
touch.press(x=303, y=818).perform()
driver.implicitly_wait(30)
