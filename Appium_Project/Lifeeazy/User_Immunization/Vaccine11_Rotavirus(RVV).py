...
driver.find_element('xpath',"//android.view.View[@bounds='[0,316][576,492]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=348).perform()
...
driver.find_element('xpath','//android.widget.Button[@content-desc="2009"]').click()
driver.find_element('xpath','//android.widget.Button[@bounds="[452,317][510,374]"]').click()
driver.find_element('xpath','//android.view.View[@bounds="[257,477][319,527]"]').click()
driver.find_element('xpath','//android.widget.Button[@content-desc="OK"]').click()
driver.find_element('xpath',"//android.view.View[@bounds='[48,603][558,879]']").click()
touch.press(x=301, y=843).perform()
driver.implicitly_wait(30)
