...
# Vaccination--12 Inactivated Polio Vaccine(IPV)
...
driver.find_element('xpath',"//android.view.View[@bounds='[0,501][576,677]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=531).perform()
...
touch.press(x=301, y=792).perform()
driver.implicitly_wait(30)
