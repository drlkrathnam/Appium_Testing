...
# Vaccination--14 Japanese Encephalitis(JE) 1
...
driver.find_element('xpath',"//android.view.View[@bounds='[0,538][576,715]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=569).perform()
...
driver.find_element('xpath',"//android.view.View[@bounds='[48,629][558,905]']").click()
touch.press(x=301, y=870).perform()
driver.implicitly_wait(30)
