...
# Vaccination--16 Diphtheria, Pertussis & Tetanus(DPT) booster--1
...
driver.find_element('xpath',"//android.view.View[@bounds='[0,240][576,417]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=273).perform()
...
driver.find_element('xpath','//android.widget.Button[@content-desc="2010"]').click()
...
touch.press(x=301, y=790).perform()
driver.implicitly_wait(30)
