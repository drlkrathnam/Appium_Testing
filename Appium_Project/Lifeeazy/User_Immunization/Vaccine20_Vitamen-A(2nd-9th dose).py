...
# Vaccination--20 Vitamen-A (2nd-9th dose)
...
driver.find_element('xpath',"//android.view.View[@bounds='[0,427][576,604]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=458).perform()
...
touch.press(x=301, y=817).perform()
driver.implicitly_wait(30)
