...
driver.find_element('xpath',"//android.view.View[@bounds='[0,780][576,957]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=810).perform()
...
driver.find_element('xpath','//android.widget.Button[@content-desc="2021"]').click()
