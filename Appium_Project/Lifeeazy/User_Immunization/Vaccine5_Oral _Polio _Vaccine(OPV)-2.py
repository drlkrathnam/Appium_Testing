...
# Vaccination--5 Oral Polio Vaccine(OPV)-2
...
driver.find_element('xpath',"//android.view.View[@bounds='[0,320][576,496]']").click()

touch = TouchAction(driver)
touch.tap(x=526, y=351).perform()
...
driver.find_element('xpath','//android.widget.Button[@content-desc="2011"]').click()
